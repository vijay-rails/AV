...
export default class EventTodaySummaryInsight extends Component 
{
  static contextTypes = {
  ...
  static defaultProps = {
    accentColour: Theme.Colours.chartColor6_Purple
  }
...
const styles = StyleSheet.create({
  ...
  description: {
    ...
    color: Theme.Colours.chartColor6_Purple, // chartColor5_Pink,
    fontWeight: '400',
  },
  description2: {
    fontSize: Theme.Fonts.fontMedium,
